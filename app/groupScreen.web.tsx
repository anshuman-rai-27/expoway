    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={()=>{ 
          // navigation.navigate('Profile',{email:email as string})
          router.push({ pathname: '/userProfile', params: { email: email as string } });
        }} >
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem} onPress={()=>{
          ...
          router.push({ pathname: '/chatScreen', params: { email } });
        }}>
      ...
      <ImageBackground
        source={{ uri: 'https://fefevs.sirv.com/chatbgimage.jpg' }} // replace with your image URL
...
const styles = StyleSheet.create({
  ...
  leftbox: {
    ...
    imageBackground: {
        width: '100%',
        height: '100%',
        justifyContent: 'center', // Adjust text position inside the image
        alignItems: 'center',
        borderColor: '#000',
        borderWidth:10,
    },
